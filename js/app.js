...
(function () {
    ...
    function initMap() {
        ...
        fetch('https://raw.githubusercontent.com/markmarkoh/datamaps/master/src/js/data/phl.topo.json')
            ...
            .then(topoData => {
                ...
                leafletMap.fitBounds(geoLayer.getBounds(), { padding: [15, 15] });
    ...
    function downloadImage(format) {
        ...
        if (window.globalGeoLayer && leafletMap) {
            leafletMap.fitBounds(window.globalGeoLayer.getBounds(), { padding: [15, 15], animate: false });
        }
    ...
    function downloadPDF() {
        ...
        setTimeout(() => {
            html2canvas(mapContainer, {
                ...
                pdf.text('c ' + new Date().getFullYear() + ' LAKbayGAbayPh. Verified authentic document.', pageW / 2, pageH - 8, { align: 'center' });
